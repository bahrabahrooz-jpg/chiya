/** Property Detail — Olive Grove Estate content (ported from detail/data.js). */

const img = (id: string, w = 1400, h = 1000) =>
...
export const gallery = Array.from({ length: property.photoCount }, (_, i) => baseShots[i % baseShots.length]);
...
export const amenities: IconRow[] = [
...
export const similar: Similar[] = [
  { id: "marble-hill", title: "Marble Hill Villa", address: "Ankawa, Erbil", price: 620000, status: "For Sale", featured: true, beds: 4, baths: 3, area: 420, photoCount: 28, cover: img("1613977257363-707ba9348227", 1000, 750) },
  { id: "azadi-villa", title: "Azadi Heights Villa", address: "Azadi, Duhok", price: 760000, status: "For Sale", beds: 5, baths: 4, area: 520, photoCount: 26, cover: img("1600585154340-be6161a56a0c", 1000, 750) },
  { id: "rowanberry-villa", title: "Rowanberry Villa", address: "Italian Village, Erbil", price: 560000, status: "For Sale", featured: true, beds: 3, baths: 3, area: 240, photoCount: 21, cover: img("1605276374104-dee2a0ed3cd6", 1000, 750) },
];
