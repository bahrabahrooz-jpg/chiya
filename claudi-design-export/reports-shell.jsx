/* ==================================================================
   CHIYA ESTATE — ADMIN SHELL (shared) + chart helpers
   Exported on window so reports.jsx can compose against it.
...
/* ------------------------------------------------------------------
   CHART HELPERS (shared by every chart on the Reports page)
------------------------------------------------------------------ */
...
/* expose to reports.jsx (separate Babel scope) */
Object.assign(window, {
  Sidebar, Topbar, NavItem, ProfileMenu, NotifMenu, SidebarProfile,
  useElementWidth, niceNum, smoothPath, categoryFor,
  NAV_GROUPS, NAV_FLAT, PAGE_MAP, ADMIN, LAYOUTS,
});
